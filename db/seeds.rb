...
Couch.create(
    ...
    url: "http://www.arqhys.com/wp-content/fotos/2011/07/Fotos-de-interior-de-casas-modernas.jpg",
    user_id:lea.id,
    category_id: c1.id,   
    pais: "Argentina",
...
Couch.create(
    ...
    url: "http://www.arqhys.com/wp-content/fotos/2011/07/Fotos-de-casas-modernas-interiores.jpg",
    user_id:gabi.id,
    category_id: c1.id,
    pais: "Argentina",
    provincia: "Neuquen",
...
Couch.create(
    ...
    url: "http://imagenesdecasasmodernas.com/wp-content/uploads/2015/11/modelos-de-fachadas-de-casas-peque%C3%B1as-sencillas.jpg",
    user_id:axl.id,
    category_id: c1.id,
    pais: "Argentina",
    provincia: "Buenos Aires",
